...
textLoader = TextLoader('/media/nsl3090-3/hdd1/hujaifa/Langchain_RAG/Text/samurai.txt')
...
text_splitter = RecursiveCharacterTextSplitter(chunk_size=32, chunk_overlap=5, separators='\n\n\n')
